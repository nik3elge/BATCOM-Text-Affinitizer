      ...
      >
        ...
        <div className="w-full sm:w-[420px] md:w-[450px] shrink-0 snap-start bg-white/90 backdrop-blur-xs p-3.5 sm:p-4 rounded-xl border border-blue-100/80 shadow-2xs flex flex-col">
          ...
          <div className="text-xs text-slate-600 leading-relaxed space-y-1.5">
            <p>Вставьте ваш рабочий текст в поле ввода или загрузите текстовый файл.</p>
        ...
        <div className="w-full sm:w-[420px] md:w-[450px] shrink-0 snap-start bg-white/90 backdrop-blur-xs p-3.5 sm:p-4 rounded-xl border border-blue-100/80 shadow-2xs flex flex-col">
          ...
          <div className="text-xs text-slate-600 leading-relaxed space-y-2">
            ...
            <div className="pl-2.5 sm:pl-3 border-l-2 border-slate-200 space-y-1.5 my-2">
              ...
              <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2 text-[11px]">
                <code className="bg-slate-100 text-slate-800 px-1.5 py-0.5 rounded border border-slate-200/80 font-mono text-[10.5px] w-fit shrink-0">^(Иван|Анна):</code>
                <span className="text-slate-600">сразу несколько персонажей</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2 text-[11px]">
                <code className="bg-slate-100 text-slate-800 px-1.5 py-0.5 rounded border border-slate-200/80 font-mono text-[10.5px] w-fit shrink-0">^[А-Я\s]+:</code>
        ...
        <div className="w-full sm:w-[420px] md:w-[450px] shrink-0 snap-start bg-white/90 backdrop-blur-xs p-3.5 sm:p-4 rounded-xl border border-blue-100/80 shadow-2xs flex flex-col">
          ...
          <div className="text-xs text-slate-600 leading-relaxed space-y-1.5">
            ...
            <div className="mt-3 p-3 rounded-xl bg-gradient-to-r from-indigo-50/90 via-blue-50/80 to-indigo-50/70 border border-indigo-200/80 shadow-2xs flex items-start gap-2.5 text-slate-800">
              ...
              <p className="text-[11px] leading-relaxed text-slate-700 font-medium">
                Для применения стилей выберите <b>весь текст (Ctrl+A)</b> и нажмите кнопку <b className="font-bold text-indigo-950 underline decoration-indigo-300 underline-offset-2">Reapply Text Styles</b> в панели <b>Text Styles</b>.
              </p>
            </div>
          </div>
        </div>
