      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full border border-slate-100 overflow-hidden p-6 relative flex flex-col gap-4">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-base font-bold text-slate-900">Очистить список правил?</h3>
            <p className="text-slate-500 text-xs mt-1.5 leading-relaxed">
              Вы уверены, что хотите полностью очистить Блок Б? Все созданные правила будут удалены. Это действие нельзя отменить.
            </p>
            <p className="text-slate-400 text-[11px] mt-2 italic">
              Если вы просто хотите восстановить стандартные правила по умолчанию, выберите соответствующую опцию ниже.
            </p>
          </div>
        </div>
